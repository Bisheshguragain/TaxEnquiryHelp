...
const industryLinks: Record<string, IndustryLink[]> = {
  ...
  'question:hmrc-asking-for-epos-till-records': [{ href: '/industries/hmrc-enquiries-restaurants-hospitality', label: 'HMRC enquiries for restaurants and hospitality', context: 'Apply the EPOS reconciliation to cash, card, delivery-platform, VAT and stock records.' }],
  'question:hmrc-letter-online-marketplace-income': [{ href: '/industries/hmrc-undeclared-income-online-sellers', label: 'HMRC questions for online sellers', context: 'Review marketplace reports, trading income, personal disposals, stock and disclosure together.' }],
  'question:online-selling-trading-or-personal-possessions': [{ href: '/industries/hmrc-undeclared-income-online-sellers', label: 'HMRC questions for online sellers', context: 'Apply the trading analysis to multi-platform sales, fees, stock and tax-year records.' }],
  'question:hmrc-checking-uber-bolt-delivery-app-income': [{ href: '/industries/hmrc-enquiries-taxi-private-hire-delivery-drivers', label: 'HMRC enquiries for taxi and delivery drivers', context: 'Connect platform income with cash fares, mileage, vehicle costs, VAT and status.' }],
  'question:hmrc-locum-employment-status-check': [{ href: '/industries/hmrc-enquiries-doctors-dentists-healthcare-professionals', label: 'HMRC enquiries for healthcare professionals', context: 'See how locum status fits alongside practice income, PAYE, companies and professional expenses.' }],
  'question:vat-on-medical-services-hmrc-check': [{ href: '/industries/hmrc-enquiries-doctors-dentists-healthcare-professionals', label: 'HMRC enquiries for healthcare professionals', context: 'Connect service-by-service VAT analysis with healthcare income, records and practice arrangements.' }],
