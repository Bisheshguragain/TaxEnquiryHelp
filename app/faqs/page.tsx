...
export const metadata:Metadata={
  ...
  description:'Answers to frequently asked UK questions about HMRC Self Assessment enquiries, compliance checks, VAT, PAYE, COP8, COP9, undeclared income, penalties and appeals.',
  alternates:{canonical:'/faqs'},
  openGraph:{title:'HMRC Tax Enquiry FAQs UK',description:'Clear answers to common HMRC enquiry, investigation, disclosure and appeal questions.',type:'website',locale:'en_GB'}
};
